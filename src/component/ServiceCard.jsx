...
import img from '../assets/service/servicephoto/livc.jpeg';
...
const ServiceCard = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      logo: couple,
      link: '/treatment/premarital', // Updated link
    },
  ];
  
  // Display the updated services array
  ...
  return (
   ...
   key={index}
   data-aos="fade-up"
   className="relative bg-white p-8 cursor-pointer rounded-3xl shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl duration-300 border border-gray-200 flex flex-col overflow-hidden h-full"
 >
   {/* Background Pattern */}
   <div
