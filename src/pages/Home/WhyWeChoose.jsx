...
const WhyChoose = () => {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center w-full gap-4 py-10 pb-16 overflow-hidden bg-blue-50">
    ...
    {[
        { icon: <FaFemale className="text-4xl" />, text: "Secured and Safe Rides" },
        ...
        <div
            ...
            className="relative w-full max-w-[20rem] flex items-center gap-4 lg:py-6 p-4 bg-gradient-to-r from-[#006BFF] to-[#0e5dcb] text-white rounded-lg shadow-lg transition-transform transform hover:scale-105"
        >
            {item.icon}
            <h2 className="text-xl font-semibold tracking-wide text-white">{item.text}</h2>
                ...
                <div className="relative h-[25rem] w-[32rem] flex items-center justify-center sm:my-16">
                    ...
                    <div className="absolute sm:size-[24.5rem] size-[16.5rem] rounded-full border-2 border-blue-500 flex items-center justify-center">
